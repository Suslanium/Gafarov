...
class FavouriteRepositoryImpl(
    ...
    private val summaryDao: MovieSummaryDao
) : FavouritesRepository {

    override fun getFavoriteMovies(): Flow<List<MovieSummary>> =
        summaryDao.getCachedMovies().map {
    ...
    override suspend fun addFavoriteMovie(summary: MovieSummary, details: MovieDetails) {
    ...
    override suspend fun removeFavoriteMovie(movieId: Long) {
        ...
        //detailsDao.deleteMovieDetailsById(movieId)
    }
